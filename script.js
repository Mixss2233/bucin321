const CONFIG = {
    mainQuestion: "Hii Sayangg",
    subQuestion: "Maafin Kalau Hari Ini Banyak Buat Kamu Badmood ",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["Eits, ga bisa😝", "Hehe, coba lagi 😜", "Yaudah deh, aku anggap YES ya! 💕"],
    confirmTitle: "YEAAAY! Gitu Dongg, Once Again Maafin Aku Yah Aku Janji Bakalan Lebih Baik Kedepannya",
    confirmText: "Mulai dari sekarang Aku Mau Belajar Banyak Hal Lagi Supaya",
    badgeText: "Aku Bisa Buat Hari hari mu Bahagia Terus",
    nextButton: "Lanjut ",
    ...
    collageTitle: "My Darling",
    collageSubtitle: "Sejak kamu hadir, hal sederhana pun terasa istimewa. you're my favorite person. 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "I LOVE U MORE THAN ANYTHNG",
    finalMessage: `Makasih ya sayang udah hadir di kehidupan ku yang sekali ini, kamu sangat berharga sayang bagi aku dan maaf ya sayang buat hari ini karna bikin kamu bad mood sayang, aku sayang kamu sampe kapanpun Love you❤️`,
